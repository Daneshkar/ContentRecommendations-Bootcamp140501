...
namespace EmotionService.Infrastructure.Migrations
{
    ...
    [Migration("20260918123926_AddRecommendationQueryIndexes")]
    partial class AddRecommendationQueryIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmotionService.Domain.Entities.Experience", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Experiences", null, t =>
                        {
                            t.HasCheckConstraint("CK_Experiences_Score", "[Score] BETWEEN 1 AND 5");
                        });
                });

            modelBuilder.Entity("EmotionService.Domain.Entities.ExperienceMood", b =>
                {
            ...
            modelBuilder.Entity("EmotionService.Domain.Entities.ExperienceTheme", b =>
                {
                    b.Property<Guid>("ExperienceId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EmotionService.Domain.Entities.ItemMoodWeight", b =>
                {
                    ...
                    b.HasIndex("MoodId", "MediaItemId");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("MoodId", "MediaItemId"), new[] { "WeightValue", "ExperienceCount" });
            ...
            modelBuilder.Entity("EmotionService.Domain.Entities.ItemThemeWeight", b =>
                {
                    ...
                    b.HasIndex("ThemeId", "MediaItemId");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ThemeId", "MediaItemId"), new[] { "WeightValue", "ExperienceCount" });
            ...
            modelBuilder.Entity("EmotionService.Domain.Entities.MediaItem", b =>
                {
                    ...
                    b.HasIndex("ItemTypeId", "Status", "Id");
            ...
            modelBuilder.Entity("EmotionService.Domain.Entities.MediaItemGenre", b =>
                {
                    ...
                    b.HasIndex("GenreId", "MediaItemId");
            ...
            modelBuilder.Entity("EmotionService.Domain.Entities.PendingMediaItemWeightUpdate", b =>
                {
                    b.Property<Guid>("MediaItemId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PendingMediaItemWeightUpdates", null, t =>
                        {
                            t.HasCheckConstraint("CK_PendingMediaItemWeightUpdates_Version", "[Version] > 0");
                        });
                });
            ...
            modelBuilder.Entity("EmotionService.Domain.Entities.ExperienceMood", b =>
                {
                    b.HasOne("EmotionService.Domain.Entities.Experience", "Experience")
